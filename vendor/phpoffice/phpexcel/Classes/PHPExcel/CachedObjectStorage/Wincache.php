 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_Wincache extends \PhpOffice\PhpSpreadsheet\Collection\Cells implements \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_ICache {
		...
		if ($this->_currentCellIsDirty && !empty($this->_currentObjectID)) {
			...
			if (wincache_ucache_exists($this->_cachePrefix.$this->_currentObjectID.'.cache')) {
				if (!wincache_ucache_set($this->_cachePrefix.$this->_currentObjectID.'.cache', $obj, $this->_cacheTime)) {
					$this->__destruct();
					throw new \PhpOffice\PhpSpreadsheet\Exception('Failed to store cell '.$this->_currentObjectID.' in WinCache');
				}
			} else {
