 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_Memcache extends \PhpOffice\PhpSpreadsheet\Collection\Cells implements \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_ICache {
		...
		if ($this->_currentCellIsDirty && !empty($this->_currentObjectID)) {
			...
			if (!$this->_memcache->replace($this->_cachePrefix.$this->_currentObjectID.'.cache',$obj,NULL,$this->_cacheTime)) {
				if (!$this->_memcache->add($this->_cachePrefix.$this->_currentObjectID.'.cache',$obj,NULL,$this->_cacheTime)) {
					$this->__destruct();
					throw new \PhpOffice\PhpSpreadsheet\Exception('Failed to store cell '.$this->_currentObjectID.' in MemCache');
				}
			}
	...
	/**
	 * Is a value set in the current \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_ICache for an indexed cell?
	 *
