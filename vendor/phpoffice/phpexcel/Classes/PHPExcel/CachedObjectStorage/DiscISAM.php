 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_DiscISAM extends \PhpOffice\PhpSpreadsheet\Collection\Cells implements \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_ICache {
	...
	public function copyCellCollection(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $parent) {
		...
		$newFileName = $this->_cacheDirectory.'/\PhpOffice\PhpSpreadsheet\Spreadsheet.'.$baseUnique.'.cache';
	...
	public function __construct(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $parent, $arguments) {
		...
		if (is_null($this->_fileHandle)) {
			$baseUnique = $this->_getUniqueID();
			$this->_fileName = $this->_cacheDirectory.'/\PhpOffice\PhpSpreadsheet\Spreadsheet.'.$baseUnique.'.cache';
			$this->_fileHandle = fopen($this->_fileName,'a+');
		}
