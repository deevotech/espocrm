 ...
 * @copyright	Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Reader\Xls extends \PhpOffice\PhpSpreadsheet\Reader\BaseReader implements \PhpOffice\PhpSpreadsheet\Reader\IReader
{
	// ParseXL definitions
	...
	/**
	 * Create a new \PhpOffice\PhpSpreadsheet\Reader\Xls instance
	 */
	...
	public function load($pFilename)
	{
		...
		if (!$this->_readDataOnly && $this->_drawingGroupData) {
			...
			// debug Escher stream
			//$debug = new Debug_Escher(new \PhpOffice\PhpSpreadsheet\Shared\Escher());
		...
		foreach ($this->_sheets as $sheet) {
			...
			// add sheet to \PhpOffice\PhpSpreadsheet\Spreadsheet object
...
//				echo '<br />';
				...
				if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
					...
					$width = \PhpOffice\PhpSpreadsheet\Shared\Xls::getDistanceX($this->_phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
					$height = \PhpOffice\PhpSpreadsheet\Shared\Xls::getDistanceY($this->_phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

					// calculate offsetX and offsetY of the shape
					$offsetX = $startOffsetX * \PhpOffice\PhpSpreadsheet\Shared\Xls::sizeCol($this->_phpSheet, $startColumn) / 1024;
					$offsetY = $startOffsetY * \PhpOffice\PhpSpreadsheet\Shared\Xls::sizeRow($this->_phpSheet, $startRow) / 256;
			...
			if ($this->_version == self::XLS_BIFF8) {
				foreach ($this->_sharedFormulaParts as $cell => $baseCell) {
					...
					if (($this->getReadFilter() !== NULL) && $this->getReadFilter()->readCell($column, $row, $this->_phpSheet->getTitle()) ) {
						...
						$this->_phpSheet->getCell($cell)->setValueExplicit('=' . $formula, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_FORMULA);
					}
				}
			}
			...
			if ($definedName['isBuiltInName']) {
				...
				if (count($explodes) == 2) {
					if (($docSheet = $this->_phpExcel->getSheetByName($explodes[0])) ||
						...
						$this->_phpExcel->addNamedRange( new \PhpOffice\PhpSpreadsheet\NamedRange((string)$definedName['name'], $docSheet, $extractedRange, $localOnly, $scope) );
					}
				} else {
					//	Named Value
		...
		for ($i = 0; $i < $countProperties; ++$i) {
			...
			switch ($type) {
				...
				case 0x40: // Filetime (64-bit value representing the number of 100-nanosecond intervals since January 1, 1601)
					// PHP-time
					$value = \PhpOffice\PhpSpreadsheet\Shared\OLE::OLE2LocalDate(substr($this->_summaryInformation, $secOffset + 4 + $offset, 8));
					break;
			...
			switch ($id) {
				...
				case 0x07:	//	Template
					//	Not supported by \PhpOffice\PhpSpreadsheet\Spreadsheet
					break;
...
//			echo 'Type is ',$type,', ';
			...
			switch ($type) {
				...
				case 0x40:	//	Filetime (64-bit value representing the number of 100-nanosecond intervals since January 1, 1601)
					// PHP-Time
					$value = \PhpOffice\PhpSpreadsheet\Shared\OLE::OLE2LocalDate(substr($this->_documentSummaryInformation, $secOffset + 4 + $offset, 8));
					break;
...
//		echo '<br />';
	...
	private function _readCodepage()
	{
		...
		$this->_codepage = \PhpOffice\PhpSpreadsheet\Shared\CodePage::NumberToName($codepage);
	}
	...
	private function _readXf()
	{
		...
		if (!$this->_readDataOnly) {
			...
			$objStyle->getProtection()->setLocked($isLocked ?
				\PhpOffice\PhpSpreadsheet\Style\Protection::PROTECTION_INHERIT : \PhpOffice\PhpSpreadsheet\Style\Protection::PROTECTION_UNPROTECTED);

			// bit 1; mask 0x02; 1 = Formula is hidden
			$isHidden = (0x02 & $xfTypeProt) >> 1;
			$objStyle->getProtection()->setHidden($isHidden ?
				\PhpOffice\PhpSpreadsheet\Style\Protection::PROTECTION_PROTECTED : \PhpOffice\PhpSpreadsheet\Style\Protection::PROTECTION_UNPROTECTED);
	...
	private function _readStyle()
	{
		...
		if (!$this->_readDataOnly) {
			...
			if ($isBuiltIn) {
				...
				// user-defined; not supported by \PhpOffice\PhpSpreadsheet\Spreadsheet
			}
		}
	}
	...
	private function _readSheet()
	{
		...
		switch (ord($recordData{4})) {
			case 0x00: $sheetState = \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE;    break;
			case 0x01: $sheetState = \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN;     break;
			case 0x02: $sheetState = \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN; break;
			default: $sheetState = \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE;      break;
		}
	...
	private function _readHorizontalPageBreaks()
	{
		...
		if ($this->_version == self::XLS_BIFF8 && !$this->_readDataOnly) {
			...
			for ($i = 0; $i < $nm; ++$i) {
				...
				$this->_phpSheet->setBreakByColumnAndRow($cf, $r, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW);
			}
		}
	}
	...
	private function _readVerticalPageBreaks()
	{
		...
		if ($this->_version == self::XLS_BIFF8 && !$this->_readDataOnly) {
			...
			for ($i = 0; $i < $nm; ++$i) {
				...
				$this->_phpSheet->setBreakByColumnAndRow($c, $rf, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::BREAK_COLUMN);
			}
		}
	}
	...
	private function _readPageSetup()
	{
		...
		if (!$this->_readDataOnly) {
			...
			if (!$isNotInit) {
				...
				switch ($isPortrait) {
				case 0: $this->_phpSheet->getPageSetup()->setOrientation(\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE); break;
				case 1: $this->_phpSheet->getPageSetup()->setOrientation(\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_PORTRAIT); break;
				}
		...
		if (($this->getReadFilter() !== NULL) && $this->getReadFilter()->readCell($columnString, $row + 1, $this->_phpSheet->getTitle()) ) {
			...
			if (($fmtRuns = $this->_sst[$index]['fmtRuns']) && !$this->_readDataOnly) {
				...
				for ($i = 0; $i <= $sstCount; ++$i) {
					if (isset($fmtRuns[$i])) {
						$text = \PhpOffice\PhpSpreadsheet\Shared\StringHelper::Substring($this->_sst[$index]['value'], $charPos, $fmtRuns[$i]['charPos'] - $charPos);
						$charPos = $fmtRuns[$i]['charPos'];
					} else {
						$text = \PhpOffice\PhpSpreadsheet\Shared\StringHelper::Substring($this->_sst[$index]['value'], $charPos, \PhpOffice\PhpSpreadsheet\Shared\StringHelper::CountCharacters($this->_sst[$index]['value']));
					}
				...
				$cell = $this->_phpSheet->getCell($columnString . ($row + 1));
				$cell->setValueExplicit($this->_sst[$index]['value'], \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
			}
...
//		echo '<br />';
	...
	private function _readWindow2()
	{
		...
		if ($this->_phpSheet->getSheetView()->getView() !== \PhpOffice\PhpSpreadsheet\Worksheet\SheetView::SHEETVIEW_PAGE_LAYOUT) {
			//NOTE: this setting is inferior to page layout view(Excel2007-)
			$view = $isPageBreakPreview? \PhpOffice\PhpSpreadsheet\Worksheet\SheetView::SHEETVIEW_PAGE_BREAK_PREVIEW :
				\PhpOffice\PhpSpreadsheet\Worksheet\SheetView::SHEETVIEW_NORMAL;
	...
	private function _readPageLayoutView(){
		...
		if ($fPageLayoutView === 1) {
			$this->_phpSheet->getSheetView()->setView(\PhpOffice\PhpSpreadsheet\Worksheet\SheetView::SHEETVIEW_PAGE_LAYOUT);
	...
	private function _readPane()
	{
		...
		if (!$this->_readDataOnly) {
			...
			if ($this->_frozen) {
				// frozen panes
				$this->_phpSheet->freezePane(\PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($px) . ($py + 1));
			} else {
				// unfrozen panes; split windows; not supported by \PhpOffice\PhpSpreadsheet\Spreadsheet core
			}
		}
	}
	...
	private function _readDataValidation()
	{
		...
		switch ($type) {
			case 0x00:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_NONE;		break;
			case 0x01:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_WHOLE;		break;
			case 0x02:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_DECIMAL;		break;
			case 0x03:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_LIST;		break;
			case 0x04:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_DATE;		break;
			case 0x05:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_TIME;		break;
			case 0x06:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_TEXTLENGTH;	break;
			case 0x07:	$type = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_CUSTOM;		break;
		}

		// bit: 4-6; mask: 0x00000070; error type
		$errorStyle = (0x00000070 & $options) >> 4;
		switch ($errorStyle) {
			case 0x00:	$errorStyle = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::STYLE_STOP;			break;
			case 0x01:	$errorStyle = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::STYLE_WARNING;		break;
			case 0x02:	$errorStyle = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::STYLE_INFORMATION;	break;
		}
		...
		switch ($operator) {
			case 0x00: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_BETWEEN			;	break;
			case 0x01: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_NOTBETWEEN		;	break;
			case 0x02: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_EQUAL				;	break;
			case 0x03: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_NOTEQUAL			;	break;
			case 0x04: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_GREATERTHAN		;	break;
			case 0x05: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_LESSTHAN			;	break;
			case 0x06: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_GREATERTHANOREQUAL;	break;
			case 0x07: $operator = \PhpOffice\PhpSpreadsheet\Cell\DataValidation::OPERATOR_LESSTHANOREQUAL	;	break;
		}
		...
		foreach ($cellRangeAddresses as $cellRange) {
			...
			$stRange = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::extractAllCellReferencesInRange($stRange);
...
//			var_dump($bcBitCount);
	...
	private function _readBIFF8CellAddress($cellAddressStructure)
	{
		...
		// offset: 2; size: 2; index to column or column offset + relative flags
			...
			$column = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex(0x00FF & self::_GetInt2d($cellAddressStructure, 2));
	...
	private function _readBIFF8CellRangeAddress($subData)
	{
		...
		// bit: 7-0; mask 0x00FF; column index
		$fc = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex(0x00FF & self::_GetInt2d($subData, 4));
		...
		// bit: 7-0; mask 0x00FF; column index
		$lc = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex(0x00FF & self::_GetInt2d($subData, 6));
	 ...
	 * in which case an \PhpOffice\PhpSpreadsheet\Reader\Exception is thrown
	 *
	 * @param int $index
	 * @return string|false
	 * @throws \PhpOffice\PhpSpreadsheet\Reader\Exception
	...
	{
		return \PhpOffice\PhpSpreadsheet\Shared\StringHelper::ConvertEncoding($string, 'UTF-8', $this->_codepage);
	}
	...
	{
		switch ($index) {
			case 0x00: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_NONE;
			case 0x01: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN;
			case 0x02: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_MEDIUM;
			case 0x03: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_DASHED;
			case 0x04: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_DOTTED;
			case 0x05: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THICK;
			case 0x06: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_DOUBLE;
			case 0x07: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_HAIR;
			case 0x08: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_MEDIUMDASHED;
			case 0x09: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_DASHDOT;
			case 0x0A: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_MEDIUMDASHDOT;
			case 0x0B: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_DASHDOTDOT;
			case 0x0C: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_MEDIUMDASHDOTDOT;
			case 0x0D: return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_SLANTDASHDOT;
			default:   return \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_NONE;
		}
	}
	...
	{
		switch ($index) {
			case 0x00: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_NONE;
			case 0x01: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID;
			case 0x02: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_MEDIUMGRAY;
			case 0x03: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_DARKGRAY;
			case 0x04: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_LIGHTGRAY;
			case 0x05: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_DARKHORIZONTAL;
			case 0x06: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_DARKVERTICAL;
			case 0x07: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_DARKDOWN;
			case 0x08: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_DARKUP;
			case 0x09: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_DARKGRID;
			case 0x0A: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_DARKTRELLIS;
			case 0x0B: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_LIGHTHORIZONTAL;
			case 0x0C: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_LIGHTVERTICAL;
			case 0x0D: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_LIGHTDOWN;
			case 0x0E: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_LIGHTUP;
			case 0x0F: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_LIGHTGRID;
			case 0x10: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_LIGHTTRELLIS;
			case 0x11: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_GRAY125;
			case 0x12: return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_PATTERN_GRAY0625;
			default:   return \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_NONE;
		}
	}
