...
* @package  \PhpOffice\PhpSpreadsheet\Shared\OLE
*/
class \PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\Root extends \PhpOffice\PhpSpreadsheet\Shared\OLE\PPS
	{
	...
	public function __construct($time_1st, $time_2nd, $raChild)
	{
		...
		parent::__construct(
		   null,
		   \PhpOffice\PhpSpreadsheet\Shared\OLE::Asc2Ucs('Root Entry'),
		   \PhpOffice\PhpSpreadsheet\Shared\OLE::OLE_PPS_TYPE_ROOT,
		   null,
		   null,
		   null,
		   $time_1st,
	...
	public function save($filename)
	{
		...
		if (is_resource($filename)) {
			...
			if ($this->_tmp_dir === NULL)
				$this->_tmp_dir = \PhpOffice\PhpSpreadsheet\Shared\File::sys_get_temp_dir();
	...
	public function _saveBigData($iStBlk, &$raList)
	{
		...
		for ($i = 0; $i < $iCount; ++$i) {
			if ($raList[$i]->Type != \PhpOffice\PhpSpreadsheet\Shared\OLE::OLE_PPS_TYPE_DIR) {
				$raList[$i]->Size = $raList[$i]->_DataLen();
				if (($raList[$i]->Size >= \PhpOffice\PhpSpreadsheet\Shared\OLE::OLE_DATA_SIZE_SMALL) ||
					(($raList[$i]->Type == \PhpOffice\PhpSpreadsheet\Shared\OLE::OLE_PPS_TYPE_ROOT) && isset($raList[$i]->_data)))
				{
					// Write Data
