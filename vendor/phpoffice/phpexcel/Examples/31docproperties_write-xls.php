...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->setTitle("Office 95 XLS Test Document")
							 ->setSubject("Office 95 XLS Test Document")
							 ->setDescription("Test XLS document, generated using \PhpOffice\PhpSpreadsheet\Spreadsheet")
...
$obj\PhpOffice\PhpSpreadsheet\SpreadsheetRead = \PhpOffice\PhpSpreadsheet\IOFactory::load(str_replace('.php', '.xls', __FILE__));
